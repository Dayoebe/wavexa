...
@section('content')
    ...
    <section class="border-b border-orange-200 bg-orange-50">
        <div class="mx-auto max-w-5xl px-4 py-10 sm:px-6 sm:py-16 lg:px-8">
            <a href="{{ route('radio.index') }}" class="inline-flex items-center gap-2 text-sm font-bold text-slate-600"><span aria-hidden="true">←</span> All radio stations</a>
    ...
    <section class="py-10 sm:py-16"><div class="mx-auto grid max-w-5xl gap-5 px-4 sm:px-6 lg:grid-cols-[1.15fr_0.85fr] lg:px-8">
        ...
        </dl>@if ($station->website_url)<a href="{{ $station->website_url }}" target="_blank" rel="noopener noreferrer" class="mt-7 inline-flex items-center gap-2 text-sm font-extrabold text-orange-700">Visit official website ↗</a>@endif</article>
